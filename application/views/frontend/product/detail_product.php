		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="<?php echo $pathAssets ?>images/thumb-item-01.jpg">
							<div class="wrap-pic-w">
								<img src="<?php echo $pathAssets ?>images/product-detail-01.jpg" alt="IMG-PRODUCT">
							</div>
						</div>

						<div class="item-slick3" data-thumb="<?php echo $pathAssets ?>images/thumb-item-02.jpg">
							<div class="wrap-pic-w">
								<img src="<?php echo $pathAssets ?>images/product-detail-02.jpg" alt="IMG-PRODUCT">
							</div>
						</div>

						<div class="item-slick3" data-thumb="<?php echo $pathAssets ?>images/thumb-item-03.jpg">
							<div class="wrap-pic-w">
								<img src="<?php echo $pathAssets ?>images/product-detail-03.jpg" alt="IMG-PRODUCT">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="<?php echo $pathAssets ?>images/item-02.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative">
								<img src="<?php echo $pathAssets ?>images/item-03.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative">
								<img src="<?php echo $pathAssets ?>images/item-05.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
								<img src="<?php echo $pathAssets ?>images/item-07.jpg" alt="IMG-PRODUCT">
