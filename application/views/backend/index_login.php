...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo $pathAssets ?>plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php endif ?>
    <form action="<?php echo base_url('login/redirect') ?>" method="post">
...
<!-- iCheck -->
<script src="<?php echo $pathAssets ?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
